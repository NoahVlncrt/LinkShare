...
import '/imports/ui/shards.css';

import Navigation from '/imports/ui/components/navigation.js'

const App = () => (
  <div>
    <Helmet
      title="Noah Vaillancourt"
      meta={[
      ...
      script={[
        ...
        {
          src: 'https://use.fontawesome.com/98f9747c92.js'
        }
      ]}
    />
    <Navigation/>
